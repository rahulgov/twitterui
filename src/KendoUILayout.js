...
export default class App extends React.Component {
    ...
    componentDidMount(){
        axios.get('http://35.236.53.82:3001/areachart')
        .then(res => {
...
console.log(this.state.upload)
    ...
    onAction = (event) => {
        if (event.action.type === 'alert') {
            ...
            if(event.action.value === 'Area chart'){
                ...
                axios.get('http://35.236.53.82:3001/mysql')
                .then(res => {
    ...
    //   this.setState({ upload : true});
      ...
      axios.post('http://35.236.53.82:3001/file', formData, config )
      .then((response) => {
...
return answer;
    ...
    //   this.setState({keyword : question});
        ...
        // console.log(this.state.keyword);
          ...
          axios.post(`http://35.236.53.82:3001/argsPython`, {question}  )
        .then(res => {
          console.log(res);
          console.log(res.data);
        });
